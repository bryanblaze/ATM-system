...
<h1 style="text-align:center;">ADMIN SIGNUP</h1><BR>
<div style="margin-left:650px;">
    <form  action="includes/adminsignup.inc.php" method="post"><br>
      ...
      <br>
      <button class="btn" type="submit" name="create" style="padding:10px;background-color:yellowgreen;color:white;margin-left:60px;">Create</button>
    </form>
</div>